...
class MatchThreeSlideIslands final : public GameBoard_Slide, public GameBoard_Island {
 public:
 ...
 private:
  bread::expansion::key_expansion::PasswordExpanderG mOwnedPasswordExpander;
};
